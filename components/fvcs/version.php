...
class versions {
	...
	$this->dbquery("INSERT INTO RealNames VALUES (NULL,'$name','$fullpath')");
	...
	public function maketable($dataarray,$fieldname,$table_id) {
...
$(document).ready( function () {
    ...
    <thead>
		...
		foreach ($dataarray as $datarow) {
			...
			echo "<tr class='clickable-row' data-href='http://www.freddysserver.com/codiad/workspace/drafts/fvcs/index.php?details=ID'>"; // Entsprechende REALID vorher noch ermitteln und hier mit var $RID einfügen
